...
--
-- Ported from supabase/migrations/20260901120400_user_settings.sql.
--
...
--
-- Supabase created this row from a trigger on auth.users. Here sign-up inserts
-- it in the same transaction as the user, which gives the same guarantee: there
-- is no moment in which an account exists without its settings.
