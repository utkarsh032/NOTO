...
--
-- Ported from supabase/migrations/20260901120200_devices.sql; the owner now
-- references `users` instead of `profiles`.
--
...
comment on column public.devices.revoked_at is
  'Set by "sign out this device", which also revokes its sessions. Signing in again clears it.';
